...
* "The Importance of Mass Trust in Validating Algorithms in a Public Space." [eLetter responding to "The accuracy, fairness, and limits of predicting recidivism" by Julia Dressel and Hany Farid](https://advances.sciencemag.org/content/4/1/eaao5580/tab-e-letters){:target="_blank"} (with Ryan Kennedy), Science Advances 4(1)
